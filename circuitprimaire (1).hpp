...
#define DEF_CIRCUIT_PRIMAIRE
  ...
  class circuit_prim : public circuit
  {
      public:
        ...
        void set_pressuris( const pressuriseur pressuris_demandee );
       ...
       void equ_etatcircuit();
       void equ_etat_echangeur();
       void equ_debit(const reacteur_base& react);
       void equ_inertie(const circuitsecondaire_base & circuitsec, const reacteur_base& react);
       void equ_tempeaucircuit(const reacteur_base& react);
       void equ_radioactivite( const centrale_base& centr,const reacteur_base& react);
